...
export const ENEMY_STATS: Record<number, EnemyStats> = {
    ...
    [ENTITY.ENEMY_GOBLIN]: { id: ENEMY_IDS.GOBLIN, name: 'Goblin', hp: 12, attack: 4, defense: 1, exp: 6, symbol: 'g', color: '#4ade80', minLevel: 1, renderKey: 'goblin', aiBehavior: 'pack', tags: ['HUMANOID'] },
    ...
    [ENTITY.ENEMY_CULTIST]: {
        id: ENEMY_IDS.CULTIST, name: 'Cultista', hp: 20, attack: 9, defense: 2, exp: 15, symbol: 'c', color: '#be123c', minLevel: 3, renderKey: 'cultist', aiBehavior: 'cautious', tags: ['HUMANOID', 'MAGIC'],
    ...
    [ENTITY.ENEMY_WRAITH]: {
        id: ENEMY_IDS.WRAITH, name: 'Espectro', hp: 35, attack: 11, defense: 3, exp: 25, symbol: 'W', color: '#6366f1', minLevel: 5, renderKey: 'wraith', aiBehavior: 'cautious', tags: ['UNDEAD', 'SPIRIT', 'FLYING'],
    ...
    [ENTITY.ENEMY_MIMIC]: { id: ENEMY_IDS.MIMIC, name: 'Mimico', hp: 38, attack: 14, defense: 5, exp: 35, symbol: 'M', color: '#92400e', minLevel: 5, renderKey: 'mimic', aiBehavior: 'aggressive', tags: ['CONSTRUCT', 'TRAP'] },
    [ENTITY.ENEMY_MAGE]: {
        id: ENEMY_IDS.MAGE, name: 'Mago Esqueleto', hp: 25, attack: 10, defense: 1, exp: 20, symbol: 'L', color: '#6366f1', minLevel: 6, renderKey: 'skeleton_mage', aiBehavior: 'cautious', tags: ['UNDEAD', 'SKELETON', 'MAGIC'],
    ...
    [ENTITY.ENEMY_DRAGON]: {
        id: ENEMY_IDS.DRAGON, name: 'Dragón Joven', hp: 70, attack: 15, defense: 8, exp: 50, symbol: 'd', color: '#f59e0b', minLevel: 7, renderKey: 'dragon', aiBehavior: 'aggressive', tags: ['DRAGON', 'FLYING'],
    ...
    [ENTITY.ENEMY_GHOST]: {
        id: ENEMY_IDS.GHOST, name: 'Fantasma', hp: 22, attack: 8, defense: 1, exp: 18, symbol: 'ø', color: '#e0f2fe', minLevel: 3, renderKey: 'wraith', aiBehavior: 'flee', tags: ['UNDEAD', 'SPIRIT', 'FLYING'], // Reusing wraith renderKey
        resistances: { 'physical': 0.5, 'poison': 0 }
    },
    [ENTITY.ENEMY_GIANT_RAT]: {
        id: ENEMY_IDS.GIANT_RAT, name: 'Rata Gigante', hp: 15, attack: 5, defense: 1, exp: 8, symbol: 'R', color: '#52525b', minLevel: 2, renderKey: 'rat', aiBehavior: 'aggressive', tags: ['BEAST'] // Reusing rat renderKey
    },
    [ENTITY.ENEMY_VETERAN_ORC]: {
        id: ENEMY_IDS.VETERAN_ORC, name: 'Orco Veterano', hp: 45, attack: 10, defense: 5, exp: 25, symbol: 'O', color: '#c2410c', minLevel: 4, renderKey: 'orc', aiBehavior: 'aggressive', tags: ['HUMANOID', 'ORC'] // Reusing orc renderKey
    },
    [ENTITY.ENEMY_ELITE_SKELETON]: {
        id: ENEMY_IDS.ELITE_SKELETON, name: 'Guardia Esqueleto', hp: 35, attack: 9, defense: 4, exp: 20, symbol: 'S', color: '#d4d4d8', minLevel: 3, renderKey: 'skeleton', aiBehavior: 'pack', tags: ['UNDEAD', 'SKELETON'] // Reusing skeleton renderKey
    },
    ...
    [ENTITY.BOSS_SKELETON_LORD]: { id: ENEMY_IDS.BOSS_SKELETON_LORD, name: 'Señor Esqueleto', hp: 80, attack: 10, defense: 5, exp: 70, symbol: 'L', color: '#fafafa', isBoss: true, minLevel: 2, renderKey: 'skeleton_lord', aiBehavior: 'boss', tags: ['UNDEAD', 'SKELETON', 'BOSS'] },
    ...
    [ENTITY.BOSS_SPIDER_QUEEN]: { id: ENEMY_IDS.BOSS_SPIDER_QUEEN, name: 'Reina Araña', hp: 90, attack: 14, defense: 5, exp: 100, symbol: 'Q', color: '#9333ea', isBoss: true, minLevel: 4, renderKey: 'spider_queen', aiBehavior: 'boss', tags: ['BEAST', 'INSECT', 'BOSS'] },
    [ENTITY.BOSS_GOLEM_KING]: { id: ENEMY_IDS.BOSS_GOLEM_KING, name: 'Rey Gólem', hp: 140, attack: 14, defense: 12, exp: 120, symbol: 'K', color: '#57534e', isBoss: true, minLevel: 4, renderKey: 'golem_king', aiBehavior: 'boss', tags: ['CONSTRUCT', 'GIANT', 'BOSS'] },
    [ENTITY.BOSS_LICH]: {
    ...
    [ENTITY.BOSS_VAMPIRE_LORD]: {
        id: ENEMY_IDS.BOSS_VAMPIRE_LORD, name: 'Señor Vampiro', hp: 130, attack: 17, defense: 6, exp: 145, symbol: 'V', color: '#991b1b', isBoss: true, minLevel: 5, renderKey: 'vampire_lord', aiBehavior: 'boss', tags: ['UNDEAD', 'VAMPIRE', 'BOSS'],
        attacks: [{ type: 'magic', range: 5, name: 'Drenar Almas', color: '#991b1b', effect: { type: 'drain', duration: 0, chance: 1 } }]
    },
    [ENTITY.BOSS_DEMON_LORD]: {
        id: ENEMY_IDS.BOSS_DEMON_LORD, name: 'Señor Demonio', hp: 150, attack: 18, defense: 8, exp: 160, symbol: 'D', color: '#dc2626', isBoss: true, minLevel: 6, renderKey: 'demon_lord', aiBehavior: 'boss', tags: ['DEMON', 'BOSS'],
