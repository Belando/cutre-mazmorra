...
function getMessageColor(type) {
  switch (type) {
    case 'player_damage': return 'text-green-400'; // Jugador hace daño
    case 'enemy_damage': return 'text-red-400'; // Enemigo hace daño
    case 'damage': return 'text-orange-400'; // Daño genérico
