...
import { 
  ...
  GiCultist,         // Arcane
  GiDeerHead,        // Druid (CORRECCIÓN: Reemplaza a GiCernunnos que da error)
  GiCowled,          // Assassin
  GiBowman,          // Archer
  // Iconos de Stats
  GiMagicTrident, 
...
const CLASS_ICONS = {
  ...
  arcane: GiCultist,
  druid: GiDeerHead, // Icono corregido
  assassin: GiCowled,
  archer: GiBowman,
  default: GiSpartanHelmet
};

export default function PlayerStats({ player, dungeonLevel, onOpenInventory, inventoryCount }) {
  ...
  // Usamos la función centralizada para calcular totales (Base + Equipo)
  const stats = calculatePlayerStats(player);
  
  // Seleccionar icono de clase
  ...
  return (
    <div className="p-2 border rounded-lg bg-slate-900/80 backdrop-blur-sm border-slate-700/50">
      ...
      {/* --- GRID DE STATS (ACTUALIZADO CON MAGIA) --- */}
...
// Componente auxiliar para las cajas de estadísticas
