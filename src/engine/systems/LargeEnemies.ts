import { LARGE_ENEMIES, LargeEnemyType } from "@/data/enemies";

// Check if enemy is large
export function isLargeEnemy(enemyType: string): boolean {
    return LARGE_ENEMIES[enemyType as LargeEnemyType] !== undefined;
}
...
export function getEnemySize(enemyType: string): EnemySize {
    return LARGE_ENEMIES[enemyType as LargeEnemyType] || { width: 1, height: 1, scale: 1 };
}
